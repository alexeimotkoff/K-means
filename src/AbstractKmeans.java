...
public class AbstractKmeans<Centroid, Point> {
    ...
    public AbstractKmeans(Centroid[] centroids, Point[] points, boolean equal, DistanceFunction<Centroid, Point> distanceFunction, CenterFunction<Centroid, Point> centerFunction, Listener listener) {
